      ...
      try {
        ...
        const userInfo = {
          ...
          providerData: {
            ...
            uid:
              operationType !== "signIn"
                ? value?.providerData[0]?.uid
                : value?.user?.providerData[0]?.uid || null,
            displayName:
              operationType !== "signIn"
                ? value?.providerData[0]?.displayName
                : value?.user?.providerData[0]?.displayName || null,
            email:
              operationType !== "signIn"
                ? value?.providerData[0]?.email
                : value?.user?.providerData[0]?.email || null,
            phoneNumber:
              operationType !== "signIn"
                ? value?.providerData[0]?.phoneNumber
                : value?.user?.providerData[0]?.phoneNumber || null,
            photoURL:
              operationType !== "signIn"
                ? value?.providerData[0]?.photoURL
                : value?.user?.providerData[0]?.photoURL || null,
          },
          stsTokenManager: {
            refreshToken:
              operationType !== "signIn"
            ...
            expirationTime:
              operationType !== "signIn"
                ...
                : value?.user?.stsTokenManager?.expirationTime,
          },
        };
